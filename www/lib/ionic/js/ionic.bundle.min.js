...
!function () {
  ...
  function h(e) {
    U = null;
    var t = !1;
    "SELECT" == e.tagName ? (n("mousedown", e, 0, 0), e.focus && e.focus(), t = !0) : v() === e ? t = !0 : /^(input|textarea)$/i.test(e.tagName) || e.isContentEditable ? (t = !0, e.focus && e.focus(), e.value = e.value, B && (U = e)) : f(), t && (v(e), ionic.trigger("ionic.focusin", {target: e}, !0))
  }
  ...
  function y(e) {
    clearTimeout(re), (!ionic.keyboard.isOpen || ionic.keyboard.isClosing) && (ionic.keyboard.isOpening = !0, ionic.keyboard.isClosing = !1), ionic.keyboard.height = e.keyboardHeight, le ? C(A, !0) : C(I, !0)
  }
  ...
  function D() {
    ionic.keyboard.isLandscape = !ionic.keyboard.isLandscape, ionic.Platform.isIOS() && A(), ionic.Platform.isAndroid() && (ionic.keyboard.isOpen && V() ? le = !0 : C(A, !1))
  }
  ...
  function C(e, t) {
    ...
    return n = ionic.Platform.isAndroid() && ionic.Platform.version() < 4.4 ? 30 : ionic.Platform.isAndroid() ? 10 : 1, ie = setInterval(function () {
      a = G(), (!(++i < n) || (N(a) || O(a)) && ionic.keyboard.height) && (V() || (ionic.keyboard.height = Math.abs(r - window.innerHeight)), ionic.keyboard.isOpen = t, clearInterval(ie), e())
    }, 50), n
  }
  ...
  window.ionic = window.ionic || {}, window.ionic.views = {}, window.ionic.version = "1.2.1", function (e) {
    ...
    function r() {
      setTimeout(function () {
        !h.isReady && h.isWebView()
      }, v)
    }

    function a() {
      h.isWebView() ? t.addEventListener("deviceready", o, !1) : o(), s && e.removeEventListener("load", a, !1)
    }

    function o() {
      h.isReady = !0, h.detect();
      for (var e = 0; e < g.length; e++)g[e]();
      g = [], n.trigger("platformready", {target: t}), p(function () {
        t.body.classList.add("platform-ready")
      })
    }

    var s, l = "ios", c = "android", d = "windowsphone", u = "edge", p = n.requestAnimationFrame, h = n.Platform = {
      ...
      ready: function (e) {
        h.isReady ? e() : g.push(e)
      },
      detect: function () {
        h._checkPlatforms(), p(function () {
          for (var e = 0; e < h.platforms.length; e++)t.body.classList.add("platform-" + h.platforms[e])
        })
      },
      setGrade: function (e) {
        var n = h.grade;
        h.grade = e, p(function () {
      ...
      _checkPlatforms: function () {
        h.platforms = [];
        var t = "a";
        h.isWebView() ? (h.platforms.push("webview"), e.cordova || e.PhoneGap || e.phonegap ? h.platforms.push("cordova") : e.forge && h.platforms.push("trigger")) : h.platforms.push("browser"), h.isIPad() && h.platforms.push("ipad");
        var n = h.platform();
        if (n) {
          h.platforms.push(n);
          var i = h.version();
          if (i) {
            var r = i.toString();
            r.indexOf(".") > 0 ? r = r.replace(".", "_") : r += "_0", h.platforms.push(n + r.split("_")[0]), h.platforms.push(n + r), h.isAndroid() && 4.4 > i ? t = 4 > i ? "c" : "b" : h.isWindowsPhone() && (t = "b")
          }
        }
        h.setGrade(t)
      },
      ...
      isIPad: function () {
        return /iPad/i.test(h.navigator.platform) ? !0 : /iPad/i.test(h.ua)
      },
      isIOS: function () {
        return h.is(l)
      },
      ...
      platform: function () {
        return null === f && h.setPlatform(h.device().platform), f
      },
      setPlatform: function (e) {
        f = "undefined" != typeof e && null !== e && e.length ? e.toLowerCase() : i("ionicplatform") ? i("ionicplatform") : h.ua.indexOf("Edge") > -1 ? u : h.ua.indexOf("Windows Phone") > -1 ? d : h.ua.indexOf("Android") > 0 ? c : /iPhone|iPad|iPod/.test(h.ua) ? l : h.navigator.platform && navigator.platform.toLowerCase().split(" ")[0] || ""
      },
      version: function () {
        return null === m && h.setVersion(h.device().version), m
      },
      setVersion: function (e) {
        if ("undefined" != typeof e && null !== e && (e = e.split("."), e = parseFloat(e[0] + "." + (e.length > 1 ? e[1] : 0)), !isNaN(e)))return void(m = e);
        m = 0;
        var t = h.platform(), n = {
          android: /Android (\d+).(\d+)?/,
          ios: /OS (\d+)_(\d+)?/,
        ...
        n[t] && (e = h.ua.match(n[t]), e && e.length > 2 && (m = parseFloat(e[1] + "." + e[2])))
      },
      is: function (e) {
        if (e = e.toLowerCase(), h.platforms)for (var t = 0; t < h.platforms.length; t++)if (h.platforms[t] === e)return !0;
        var n = h.platform();
        return n ? n === e.toLowerCase() : h.ua.toLowerCase().indexOf(e) >= 0
      },
      exitApp: function () {
        h.ready(function () {
      ...
      showStatusBar: function (n) {
        h._showStatusBar = n, h.ready(function () {
          p(function () {
            h._showStatusBar ? (e.StatusBar && e.StatusBar.show(), t.body.classList.remove("status-bar-hide")) : (e.StatusBar && e.StatusBar.hide(), t.body.classList.add("status-bar-hide"))
          })
        })
      },
      fullScreen: function (e, i) {
        h.isFullScreen = e !== !1, n.DomUtil.ready(function () {
          p(function () {
            h.isFullScreen ? t.body.classList.add("fullscreen") : t.body.classList.remove("fullscreen")
          }), h.showStatusBar(i === !0)
        })
      }
    }, f = null, m = null, g = [], v = 2e3;
    r(), "complete" === t.readyState ? a() : (s = !0, e.addEventListener("load", a, !1))
  }(window, document, ionic), function (e, t) {
    "use strict";
    t.CSS = {}, t.CSS.TRANSITION = [], t.CSS.TRANSFORM = [], function () {
  ...
  ionic.keyboard = {
    ...
    z(), window.addEventListener("orientationchange", D), setTimeout(z, 999), window.navigator.msPointerEnabled ? document.addEventListener("MSPointerDown", S, !1) : document.addEventListener("touchstart", S, !1)
  });
  var he, fe = {};
  ionic.viewport = {
  ...
  !function (e) {
    ...
    e.views.ScrollNative = e.views.View.inherit({
      initialize: function (n) {
        var i = this;
        i.__container = i.el = n.el, i.__content = n.el.firstElementChild, i.isNative = !0, i.__scrollTop = i.el.scrollTop, i.__scrollLeft = i.el.scrollLeft, i.__clientHeight = i.__content.clientHeight, i.__clientWidth = i.__content.clientWidth, i.__maxScrollTop = Math.max(i.__contentHeight - i.__clientHeight, 0), i.__maxScrollLeft = Math.max(i.__contentWidth - i.__clientWidth, 0), (n.startY >= 0 || n.startX >= 0) && e.requestAnimationFrame(function () {
          i.el.scrollTop = n.startY || 0, i.el.scrollLeft = n.startX || 0, i.__scrollTop = i.el.scrollTop, i.__scrollLeft = i.el.scrollLeft
        }), i.options = {
        ...
        a.el.style.overflowY = "hidden", a.el.style.overflowX = "hidden", r(n, t)
      }, __waitForSize: function () {
        var e = this;
        clearTimeout(e.__sizerTimeout);
        var t = function () {
        ...
        n.scrollChildIntoView = function (r) {
          var a = i.getBoundingClientRect().bottom;
          t = i.offsetHeight;
          var o = n.isShrunkForKeyboard, s = i.parentNode.classList.contains("modal"), l = i.parentNode.classList.contains("popover"), c = s && window.innerWidth >= 680;
          if (!o) {
            if (!l && (e.Platform.isIOS() || e.Platform.isFullScreen || c)) {
              var d = r.detail.viewportHeight - a, u = Math.max(0, r.detail.keyboardHeight - d);
              e.requestAnimationFrame(function () {
          ...
          r.detail.isElementUnderKeyboard && e.requestAnimationFrame(function () {
            n.isShrunkForKeyboard && !o && (a = i.getBoundingClientRect().bottom);
            var s = .5 * t, l = (r.detail.elementBottom + r.detail.elementTop) / 2, c = l - a, d = c + s;
            d > 0 && (e.Platform.isIOS() ? setTimeout(function () {
              e.tap.cloneFocusedInput(i, n), n.scrollBy(0, d, !0), n.onScroll()
            }, 32) : (n.scrollBy(0, d, !0), n.onScroll()))
          }), r.stopPropagation()
        ...
        if (b) {
          ...
          var C, P, I = e.auto || 0, k = {}, N = {}, O = {
            handleEvent: function (n) {
              ...
              e.continuous && (i = !1);
              var a = N.x < 0;
              P || (n && !i ? (a ? (e.continuous ? (o(r(M - 1), -E, 0), o(r(M + 2), E, 0)) : o(M - 1, -E, 0), o(M, y[M] - E, L), o(r(M + 1), y[r(M + 1)] - E, L), M = r(M + 1)) : (e.continuous ? (o(r(M + 1), E, 0), o(r(M - 2), -E, 0)) : o(M + 1, E, 0), o(M, y[M] + E, L), o(r(M - 1), y[r(M - 1)] + E, L), M = r(M - 1)), e.callback && e.callback(M, S[M])) : e.continuous ? (o(r(M - 1), -E, L), o(M, 0, L), o(r(M + 1), E, L)) : (o(M - 1, -E, L), o(M, 0, L), o(M + 1, E, L))), D.removeEventListener(p, O, !1), D.removeEventListener(g, O, !1), D.removeEventListener(h, O, !1), D.removeEventListener(v, O, !1), document.removeEventListener(h, O, !1), document.removeEventListener(v, O, !1), e.onDragEnd && e.onDragEnd()
    ...
    var t, n = function (e, r) {
      ...
      function d(e) {
        ...
        if (!b.params.allowSwipeToNext && (a() && 39 === t || !a() && 40 === t))return !1;
        if (!b.params.allowSwipeToPrev && (a() && 37 === t || !a() && 38 === t))return !1;
        if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
          if (37 === t || 39 === t || 38 === t || 40 === t) {
            ...
            }, r = window.innerWidth, o = window.innerHeight, s = b.container.offset();
            b.rtl && (s.left = s.left - b.container[0].scrollLeft);
            for (var l = [[s.left, s.top], [s.left + b.width, s.top], [s.left, s.top + b.height], [s.left + b.width, s.top + b.height]], c = 0; c < l.length; c++) {
              var d = l[c];
              d[0] >= i.left && d[0] <= i.left + r && d[1] >= i.top && d[1] <= i.top + o && (n = !0)
            }
            if (!n)return
          }
          a() ? ((37 === t || 39 === t) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), (39 === t && !b.rtl || 37 === t && b.rtl) && b.slideNext(), (37 === t && !b.rtl || 39 === t && b.rtl) && b.slidePrev()) : ((38 === t || 40 === t) && (e.preventDefault ? e.preventDefault() : e.returnValue = !1), 40 === t && b.slideNext(), 38 === t && b.slidePrev())
        }
      }
      ...
      function u(e) {
        ...
        if (e.detail)n = -e.detail; else if ("mousewheel" === t)if (b.params.mousewheelForceToAxis)if (a()) {
          if (!(Math.abs(e.wheelDeltaX) > Math.abs(e.wheelDeltaY)))return;
          n = e.wheelDeltaX * i
        } else {
          if (!(Math.abs(e.wheelDeltaY) > Math.abs(e.wheelDeltaX)))return;
          n = e.wheelDeltaY
        } else n = Math.abs(e.wheelDeltaX) > Math.abs(e.wheelDeltaY) ? -e.wheelDeltaX * i : -e.wheelDeltaY; else if ("DOMMouseScroll" === t)n = -e.detail; else if ("wheel" === t)if (b.params.mousewheelForceToAxis)if (a()) {
        ...
        if (0 !== n) {
          if (b.params.mousewheelInvert && (n = -n), b.params.freeMode) {
            var r = b.getWrapperTranslate() + n * b.params.mousewheelSensitivity, o = b.isBeginning, s = b.isEnd;
            if (r >= b.minTranslate() && (r = b.minTranslate()), r <= b.maxTranslate() && (r = b.maxTranslate()), b.setWrapperTransition(0), b.setWrapperTranslate(r), b.updateProgress(), b.updateActiveIndex(), (!o && b.isBeginning || !s && b.isEnd) && b.updateClasses(), b.params.freeModeSticky && (clearTimeout(b.mousewheel.timeout), b.mousewheel.timeout = setTimeout(function () {
                b.slideReset()
              }, 300)), 0 === r || r === b.maxTranslate())return
          } else {
      ...
      function p(e, n) {
        e = t(e);
        var i, r, o, s = b.rtl ? -1 : 1;
        i = e.attr("data-swiper-parallax") || "0", r = e.attr("data-swiper-parallax-x"), o = e.attr("data-swiper-parallax-y"), r || o ? (r = r || "0", o = o || "0") : a() ? (r = i, o = "0") : (o = i, r = "0"), r = r.indexOf("%") >= 0 ? parseInt(r, 10) * n * s + "%" : r * n * s + "px", o = o.indexOf("%") >= 0 ? parseInt(o, 10) * n + "%" : o * n + "px", e.transform("translate3d(" + r + ", " + o + ",0px)")
      }
      ...
      r = r || {};
      var g = {};
      for (var v in r)if ("object" != typeof r[v] || (r[v].nodeType || r[v] === window || r[v] === document || "undefined" != typeof i && r[v] instanceof i || "undefined" != typeof jQuery && r[v] instanceof jQuery))g[v] = r[v]; else {
        g[v] = {};
        for (var _ in r[v])g[v][_] = r[v][_]
      }
      for (var w in f)if ("undefined" == typeof r[w])r[w] = f[w]; else if ("object" == typeof r[w])for (var T in f[w])"undefined" == typeof r[w][T] && (r[w][T] = f[w][T]);
      var b = this;
      if (b.params = r, b.originalParams = g, b.classNames = [], "undefined" != typeof t && "undefined" != typeof i && (t = i), ("undefined" != typeof t || (t = "undefined" == typeof i ? window.Dom7 || window.Zepto || window.jQuery : i)) && (b.$ = t, b.currentBreakpoint = void 0, b.getActiveBreakpoint = function () {
        ...
        var S = angular.element(b.wrapper).injector().get("$compile");
        b.lockSwipeToNext = function () {
          ...
          var l, c = b.params.slidesPerColumn, d = s / c, u = d - (b.params.slidesPerColumn * d - b.slides.length);
          for (e = 0; e < b.slides.length; e++) {
            l = 0;
            var p = b.slides.eq(e);
            if (b.params.slidesPerColumn > 1) {
              var h, f, m;
              "column" === b.params.slidesPerColumnFill ? (f = Math.floor(e / c), m = e - f * c, (f > u || f === u && m === c - 1) && ++m >= c && (m = 0, f++), h = f + m * s / c, p.css({
                "-webkit-box-ordinal-group": h,
                "-moz-box-ordinal-group": h,
                "-ms-flex-order": h,
                "-webkit-order": h,
                order: h
              })) : (m = Math.floor(e / d), f = e - m * d), p.css({"margin-top": 0 !== m && b.params.spaceBetween && b.params.spaceBetween + "px"}).attr("data-swiper-column", f).attr("data-swiper-row", m)
            }
            "none" !== p.css("display") && ("auto" === b.params.slidesPerView ? (l = a() ? p.outerWidth(!0) : p.outerHeight(!0), b.params.roundLengths && (l = o(l))) : (l = (b.size - (b.params.slidesPerView - 1) * t) / b.params.slidesPerView, b.params.roundLengths && (l = o(l)), a() ? b.slides[e].style.width = l + "px" : b.slides[e].style.height = l + "px"), b.slides[e].swiperSlideSize = l, b.slidesSizesGrid.push(l), b.params.centeredSlides ? (n = n + l / 2 + i / 2 + t, 0 === e && (n = n - b.size / 2 - t), Math.abs(n) < .001 && (n = 0), r % b.params.slidesPerGroup === 0 && b.snapGrid.push(n), b.slidesGrid.push(n)) : (r % b.params.slidesPerGroup === 0 && b.snapGrid.push(n), b.slidesGrid.push(n), n = n + l + t), b.virtualSize += l + t, i = l, r++)
          }
          ...
          0 === b.snapGrid.length && (b.snapGrid = [0]), 0 !== b.params.spaceBetween && (a() ? b.rtl ? b.slides.css({marginLeft: t + "px"}) : b.slides.css({marginRight: t + "px"}) : b.slides.css({marginBottom: t + "px"})), b.params.watchSlidesProgress && b.updateSlidesOffset()
        }, b.updateSlidesOffset = function () {
          for (var e = 0; e < b.slides.length; e++)b.slides[e].swiperSlideOffset = a() ? b.slides[e].offsetLeft : b.slides[e].offsetTop
          ...
          if ("undefined" == typeof e && (e = b.translate || 0), 0 !== b.slides.length) {
            ...
            for (var n = 0; n < b.slides.length; n++) {
              var i = b.slides[n], r = (t - i.swiperSlideOffset) / (i.swiperSlideSize + b.params.spaceBetween);
              if (b.params.watchSlidesVisibility) {
                var a = -(t - i.swiperSlideOffset), o = a + b.slidesSizesGrid[n], s = a >= 0 && a < b.size || o > 0 && o <= b.size || 0 >= a && o >= b.size;
        ...
        window.navigator.pointerEnabled ? y = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (y = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), b.touchEvents = {
          ...
          var n = l(e, "." + b.params.slideClass), i = !1;
          if (n)for (var r = 0; r < b.slides.length; r++)b.slides[r] === n && (i = !0);
        ...
        var E, x, D, M, L, C, P, I, k, N, O = "input, select, textarea, button", A = Date.now(), z = [];
        ...
        if (b.onTouchStart = function (e) {
            if (e.originalEvent && (e = e.originalEvent), G = "touchstart" === e.type, G || !("which" in e) || 3 !== e.which) {
              ...
              if (!b.params.swipeHandler || l(e, b.params.swipeHandler)) {
                ...
                if (!(b.device.ios && b.params.iOSEdgeSwipeDetection && n <= b.params.iOSEdgeSwipeThreshold)) {
                  if (E = !0, x = !1, D = !0, L = void 0, V = void 0, b.touches.startX = n, b.touches.startY = i, M = Date.now(), b.allowClick = !0, b.updateContainerSize(), b.swipeDirection = void 0, b.params.threshold > 0 && (I = !1), "touchstart" !== e.type) {
                    var r = !0;
            ...
            if (e.originalEvent && (e = e.originalEvent), !(G && "mousemove" === e.type || e.preventedByNestedSwiper)) {
              if (b.params.onlyExternal)return b.allowClick = !1, void(E && (b.touches.startX = b.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, b.touches.startY = b.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, M = Date.now()));
              if (G && document.activeElement && e.target === document.activeElement && t(e.target).is(O))return x = !0, void(b.allowClick = !1);
              if (D && b.emit("onTouchMove", b, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                if (b.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, b.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, "undefined" == typeof L) {
                  ...
                  L = a() ? n > b.params.touchAngle : 90 - n > b.params.touchAngle
                }
                if (L && b.emit("onTouchMoveOpposite", b, e), "undefined" == typeof V && b.browser.ieTouch && (b.touches.currentX !== b.touches.startX || b.touches.currentY !== b.touches.startY) && (V = !0), E) {
                  if (L)return void(E = !1);
                  if (V || !b.browser.ieTouch) {
                    b.allowClick = !1, b.emit("onSliderMove", b, e), e.preventDefault(), b.params.touchMoveStopPropagation && !b.params.nested && e.stopPropagation(), x || (r.loop && b.fixLoop(), P = b.getWrapperTranslate(), b.setWrapperTransition(0), b.animating && b.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), b.params.autoplay && b.autoplaying && (b.params.autoplayDisableOnInteraction ? b.stopAutoplay() : b.pauseAutoplay()), N = !1, b.params.grabCursor && (b.container[0].style.cursor = "move", b.container[0].style.cursor = "-webkit-grabbing", b.container[0].style.cursor = "-moz-grabbin", b.container[0].style.cursor = "grabbing")), x = !0;
                    var i = b.touches.diff = a() ? b.touches.currentX - b.touches.startX : b.touches.currentY - b.touches.startY;
                    i *= b.params.touchRatio, b.rtl && (i = -i), b.swipeDirection = i > 0 ? "prev" : "next", C = i + P;
                    var o = !0;
                    if (i > 0 && C > b.minTranslate() ? (o = !1, b.params.resistance && (C = b.minTranslate() - 1 + Math.pow(-b.minTranslate() + P + i, b.params.resistanceRatio))) : 0 > i && C < b.maxTranslate() && (o = !1, b.params.resistance && (C = b.maxTranslate() + 1 - Math.pow(b.maxTranslate() - P - i, b.params.resistanceRatio))), o && (e.preventedByNestedSwiper = !0), !b.params.allowSwipeToNext && "next" === b.swipeDirection && P > C && (C = P), !b.params.allowSwipeToPrev && "prev" === b.swipeDirection && C > P && (C = P), b.params.followFinger) {
                      if (b.params.threshold > 0) {
                        if (!(Math.abs(i) > b.params.threshold || I))return void(C = P);
                        if (!I)return I = !0, b.touches.startX = b.touches.currentX, b.touches.startY = b.touches.currentY, C = P, void(b.touches.diff = a() ? b.touches.currentX - b.touches.startX : b.touches.currentY - b.touches.startY)
                      }
                      (b.params.freeMode || b.params.watchSlidesProgress) && b.updateActiveIndex(), b.params.freeMode && (0 === z.length && z.push({
                        position: b.touches[a() ? "startX" : "startY"],
                        time: M
                      }), z.push({
                        position: b.touches[a() ? "currentX" : "currentY"],
            ...
            if (e.originalEvent && (e = e.originalEvent), D && b.emit("onTouchEnd", b, e), D = !1, E) {
              b.params.grabCursor && x && E && (b.container[0].style.cursor = "move", b.container[0].style.cursor = "-webkit-grab", b.container[0].style.cursor = "-moz-grab", b.container[0].style.cursor = "grab");
              var n = Date.now(), i = n - M;
              if (b.allowClick && (b.updateClickedSlide(e), b.emit("onTap", b, e), 300 > i && n - A > 300 && (k && clearTimeout(k), k = setTimeout(function () {
                ...
                }, 300)), 300 > i && 300 > n - A && (k && clearTimeout(k), b.emit("onDoubleTap", b, e))), A = Date.now(), setTimeout(function () {
                  b && (b.allowClick = !0)
                }, 0), !E || !x || !b.swipeDirection || 0 === b.touches.diff || C === P)return void(E = x = !1);
              E = x = !1;
              var r;
              if (r = b.params.followFinger ? b.rtl ? b.translate : -b.translate : -C, b.params.freeMode) {
                ...
                if (b.params.freeModeMomentum) {
                  if (z.length > 1) {
                    var a = z.pop(), o = z.pop(), s = a.position - o.position, l = a.time - o.time;
                  ...
                  z.length = 0;
                  var c = 1e3 * b.params.freeModeMomentumRatio, d = b.velocity * c, u = b.translate + d;
                  b.rtl && (u = -u);
                  var p, h = !1, f = 20 * Math.abs(b.velocity) * b.params.freeModeMomentumBounceRatio;
                  if (u < b.maxTranslate())b.params.freeModeMomentumBounce ? (u + b.maxTranslate() < -f && (u = b.maxTranslate() - f), p = b.maxTranslate(), h = !0, N = !0) : u = b.maxTranslate(); else if (u > b.minTranslate())b.params.freeModeMomentumBounce ? (u - b.minTranslate() > f && (u = b.minTranslate() + f), p = b.minTranslate(), h = !0, N = !0) : u = b.minTranslate(); else if (b.params.freeModeSticky) {
                    var m, g = 0;
                  ...
                  if (0 !== b.velocity)c = b.rtl ? Math.abs((-u - b.translate) / b.velocity) : Math.abs((u - b.translate) / b.velocity); else if (b.params.freeModeSticky)return void b.slideReset();
                  b.params.freeModeMomentumBounce && h ? (b.updateProgress(p), b.setWrapperTransition(c), b.setWrapperTranslate(u), b.onTransitionStart(), b.animating = !0, b.wrapper.transitionEnd(function () {
                    b && N && (b.emit("onMomentumBounce", b), b.setWrapperTransition(b.params.speed), b.setWrapperTranslate(p), b.wrapper.transitionEnd(function () {
                      b && b.onTransitionEnd()
                    }))
              ...
              var v, _ = 0, w = b.slidesSizesGrid[0];
              for (v = 0; v < b.slidesGrid.length; v += b.params.slidesPerGroup)"undefined" != typeof b.slidesGrid[v + b.params.slidesPerGroup] ? r >= b.slidesGrid[v] && r < b.slidesGrid[v + b.params.slidesPerGroup] && (_ = v, w = b.slidesGrid[v + b.params.slidesPerGroup] - b.slidesGrid[v]) : r >= b.slidesGrid[v] && (_ = v, w = b.slidesGrid[b.slidesGrid.length - 1] - b.slidesGrid[b.slidesGrid.length - 2]);
              var T = (r - b.slidesGrid[_]) / w;
              if (i > b.params.longSwipesMs) {
                if (!b.params.longSwipes)return void b.slideTo(b.activeIndex);
                "next" === b.swipeDirection && (T >= b.params.longSwipesRatio ? b.slideTo(_ + b.params.slidesPerGroup) : b.slideTo(_)), "prev" === b.swipeDirection && (T > 1 - b.params.longSwipesRatio ? b.slideTo(_ + b.params.slidesPerGroup) : b.slideTo(_))
              } else {
                if (!b.params.shortSwipes)return void b.slideTo(b.activeIndex);
                "next" === b.swipeDirection && b.slideTo(_ + b.params.slidesPerGroup), "prev" === b.swipeDirection && b.slideTo(_)
              }
            }
            ...
            var i = 0, r = 0, s = 0;
            a() ? i = b.rtl ? -e : e : r = e, b.params.roundLengths && (i = o(i), r = o(r)), b.params.virtualTranslate || (b.support.transforms3d ? b.wrapper.transform("translate3d(" + i + "px, " + r + "px, " + s + "px)") : b.wrapper.transform("translate(" + i + "px, " + r + "px)")), b.translate = a() ? i : r;
            var l, c = b.maxTranslate() - b.minTranslate();
            l = 0 === c ? 0 : (e - b.minTranslate()) / c, l !== b.progress && b.updateProgress(e), t && b.updateActiveIndex(), "slide" !== b.params.effect && b.effects[b.params.effect] && b.effects[b.params.effect].setTranslate(b.translate), b.params.parallax && b.parallax && b.parallax.setTranslate(b.translate), b.params.scrollbar && b.scrollbar && b.scrollbar.setTranslate(b.translate), b.params.control && b.controller && b.controller.setTranslate(b.translate, n), b.emit("onSetTranslate", b, b.translate)
            ...
            return "undefined" == typeof e && (e = a() ? "x" : "y"), b.getTranslate(b.wrapper[0], e)
          }, b.observers = [], b.initObservers = function () {
            if (b.params.observeParents)for (var e = b.container.parents(), t = 0; t < e.length; t++)c(e[t]);
            c(b.container[0], {childList: !1}), c(b.wrapper[0], {attributes: !1})
          }, b.disconnectObservers = function () {
            for (var e = 0; e < b.observers.length; e++)b.observers[e].disconnect();
            b.observers = []
          }, b.createLoop = function () {
            var e = b.wrapper.children("." + b.params.slideClass + "." + b.params.slideDuplicateClass);
            ...
            for (n.each(function (e, i) {
              var r = t(this);
              e < b.loopedSlides && s.push(i), e < n.length && e >= n.length - b.loopedSlides && o.push(i), r.attr("data-swiper-slide-index", e)
            }), i = 0; i < s.length; i++)a = angular.element(s[i]).clone().addClass(b.params.slideDuplicateClass), a.removeAttr("ng-transclude"), a.removeAttr("ng-repeat"), r = angular.element(s[i]).scope(), a = S(a)(r), angular.element(b.wrapper).append(a);
            for (i = o.length - 1; i >= 0; i--)a = angular.element(o[i]).clone().addClass(b.params.slideDuplicateClass), a.removeAttr("ng-transclude"), a.removeAttr("ng-repeat"), r = angular.element(o[i]).scope(), a = S(a)(r), angular.element(b.wrapper).prepend(a)
            ...
            fade: {
              setTranslate: function () {
                for (var e = 0; e < b.slides.length; e++) {
                  ...
                  t.css({opacity: o}).transform("translate3d(" + i + "px, " + r + "px, 0px)")
                }
              ...
              setTranslate: function () {
                var e, n = 0;
                b.params.cube.shadow && (a() ? (e = b.wrapper.find(".swiper-cube-shadow"), 0 === e.length && (e = t('<div class="swiper-cube-shadow"></div>'), b.wrapper.append(e)), e.css({height: b.width + "px"})) : (e = b.container.find(".swiper-cube-shadow"), 0 === e.length && (e = t('<div class="swiper-cube-shadow"></div>'), b.container.append(e))));
                for (var i = 0; i < b.slides.length; i++) {
                  var r = b.slides.eq(i), o = 90 * i, s = Math.floor(o / 360);
                  b.rtl && (o = -o, s = Math.floor(-o / 360));
                  var l = Math.max(Math.min(r[0].progress, 1), -1), c = 0, d = 0, u = 0;
                  i % 4 === 0 ? (c = 4 * -s * b.size, u = 0) : (i - 1) % 4 === 0 ? (c = 0, u = 4 * -s * b.size) : (i - 2) % 4 === 0 ? (c = b.size + 4 * s * b.size, u = b.size) : (i - 3) % 4 === 0 && (c = -b.size, u = 3 * b.size + 4 * b.size * s), b.rtl && (c = -c), a() || (d = c, c = 0);
                  var p = "rotateX(" + (a() ? 0 : -o) + "deg) rotateY(" + (a() ? o : 0) + "deg) translate3d(" + c + "px, " + d + "px, " + u + "px)";
                  if (1 >= l && l > -1 && (n = 90 * i + 90 * l, b.rtl && (n = 90 * -i - 90 * l)), r.transform(p), b.params.cube.slideShadows) {
                    var h = a() ? r.find(".swiper-slide-shadow-left") : r.find(".swiper-slide-shadow-top"), f = a() ? r.find(".swiper-slide-shadow-right") : r.find(".swiper-slide-shadow-bottom");
                    0 === h.length && (h = t('<div class="swiper-slide-shadow-' + (a() ? "left" : "top") + '"></div>'), r.append(h)), 0 === f.length && (f = t('<div class="swiper-slide-shadow-' + (a() ? "right" : "bottom") + '"></div>'), r.append(f));
                    r[0].progress;
                ...
                if (b.wrapper.css({
                  ...
                  }), b.params.cube.shadow)if (a())e.transform("translate3d(0px, " + (b.width / 2 + b.params.cube.shadowOffset) + "px, " + -b.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + b.params.cube.shadowScale + ")"); else {
                  var m = Math.abs(n) - 90 * Math.floor(Math.abs(n) / 90), g = 1.5 - (Math.sin(2 * m * Math.PI / 360) / 2 + Math.cos(2 * m * Math.PI / 360) / 2), v = b.params.cube.shadowScale, _ = b.params.cube.shadowScale / g, w = b.params.cube.shadowOffset;
                  e.transform("scale3d(" + v + ", 1, " + _ + ") translate3d(0px, " + (b.height / 2 + w) + "px, " + -b.height / 2 / _ + "px) rotateX(-90deg)")
                }
                var T = b.isSafari || b.isUiWebView ? -b.size / 2 : 0;
                b.wrapper.transform("translate3d(0px,0," + T + "px) rotateX(" + (a() ? 0 : n) + "deg) rotateY(" + (a() ? -n : 0) + "deg)")
              }, setTransition: function (e) {
                b.slides.transition(e).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(e), b.params.cube.shadow && !a() && b.container.find(".swiper-cube-shadow").transition(e)
              }
            }, coverflow: {
              setTranslate: function () {
                for (var e = b.translate, n = a() ? -e + b.width / 2 : -e + b.height / 2, i = a() ? b.params.coverflow.rotate : -b.params.coverflow.rotate, r = b.params.coverflow.depth, o = 0, s = b.slides.length; s > o; o++) {
                  var l = b.slides.eq(o), c = b.slidesSizesGrid[o], d = l[0].swiperSlideOffset, u = (n - d - c / 2) / c * b.params.coverflow.modifier, p = a() ? i * u : 0, h = a() ? 0 : i * u, f = -r * Math.abs(u), m = a() ? 0 : b.params.coverflow.stretch * u, g = a() ? b.params.coverflow.stretch * u : 0;
                  ...
                  if (l.transform(v), l[0].style.zIndex = -Math.abs(Math.round(u)) + 1, b.params.coverflow.slideShadows) {
                    var _ = a() ? l.find(".swiper-slide-shadow-left") : l.find(".swiper-slide-shadow-top"), w = a() ? l.find(".swiper-slide-shadow-right") : l.find(".swiper-slide-shadow-bottom");
                    0 === _.length && (_ = t('<div class="swiper-slide-shadow-' + (a() ? "left" : "top") + '"></div>'), l.append(_)), 0 === w.length && (w = t('<div class="swiper-slide-shadow-' + (a() ? "right" : "bottom") + '"></div>'), l.append(w)), _.length && (_[0].style.opacity = u > 0 ? u : 0), w.length && (w[0].style.opacity = -u > 0 ? -u : 0)
                  }
                }
                if (b.browser.ie) {
                  var T = b.wrapper[0].style;
            ...
            isTouched: !1, setDragPosition: function (e) {
              var t = b.scrollbar, n = a() ? "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX || e.clientX : "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY || e.clientY, i = n - t.track.offset()[a() ? "left" : "top"] - t.dragSize / 2, r = -b.minTranslate() * t.moveDivider, o = -b.maxTranslate() * t.moveDivider;
              r > i ? i = r : i > o && (i = o), i = -i / t.moveDivider, b.updateProgress(i), b.setWrapperTranslate(i, !0)
              ...
              if (b.params.scrollbar) {
                var e = b.scrollbar;
                e.track = t(b.params.scrollbar), e.drag = e.track.find(".swiper-scrollbar-drag"), 0 === e.drag.length && (e.drag = t('<div class="swiper-scrollbar-drag"></div>'), e.track.append(e.drag)), e.drag[0].style.width = "", e.drag[0].style.height = "", e.trackSize = a() ? e.track[0].offsetWidth : e.track[0].offsetHeight, e.divider = b.size / b.virtualSize, e.moveDivider = e.divider * (e.trackSize / b.size), e.dragSize = e.trackSize * e.divider, a() ? e.drag[0].style.width = e.dragSize + "px" : e.drag[0].style.height = e.dragSize + "px", e.divider >= 1 ? e.track[0].style.display = "none" : e.track[0].style.display = "", b.params.scrollbarHide && (e.track[0].style.opacity = 0)
              }
            }, setTranslate: function () {
              if (b.params.scrollbar) {
                var e, t = b.scrollbar, n = (b.translate || 0, t.dragSize);
                e = (t.trackSize - t.dragSize) * b.progress, b.rtl && a() ? (e = -e, e > 0 ? (n = t.dragSize - e, e = 0) : -e + t.dragSize > t.trackSize && (n = t.trackSize + e)) : 0 > e ? (n = t.dragSize + e, e = 0) : e + t.dragSize > t.trackSize && (n = t.trackSize - e), a() ? (b.support.transforms3d ? t.drag.transform("translate3d(" + e + "px, 0, 0)") : t.drag.transform("translateX(" + e + "px)"), t.drag[0].style.width = n + "px") : (b.support.transforms3d ? t.drag.transform("translate3d(0px, " + e + "px, 0)") : t.drag.transform("translateY(" + e + "px)"), t.drag[0].style.height = n + "px"), b.params.scrollbarHide && (clearTimeout(t.timeout), t.track[0].style.opacity = 1, t.timeout = setTimeout(function () {
            ...
            LinearSpline: function (e, t) {
              ...
              if (b.isArray(a))for (r = 0; r < a.length; r++)a[r] !== t && a[r] instanceof n && i(a[r]); else a instanceof n && t !== a && i(a)
            }
          }, b.hashnav = {
            init: function () {
              if (b.params.hashnav) {
                ...
                if (e)for (var t = 0, n = 0, i = b.slides.length; i > n; n++) {
                  var r = b.slides.eq(n), a = r.attr("data-hash");
        ...
        for (var H in b.plugins) {
          var Y = b.plugins[H](b, b.params[H]);
          Y && b._plugins.push(Y)
        }
...
!function () {
  ...
  a.factory("$ionicPopup", ["$ionicTemplateLoader", "$ionicBackdrop", "$q", "$timeout", "$rootScope", "$ionicBody", "$compile", "$ionicPlatform", "$ionicModal", "IONIC_BACK_PRIORITY", function (e, t, n, i, o, r, a, s, l, u) {
    ...
    function r(e) {
      e.touches = e.touches || [{screenX: e.screenX, screenY: e.screenY}], V = Math.floor(e.touches[0].screenY)
    }

    function a() {
      V = null, (_ || C) && (C ? (C = !1, B = 0, I > x ? (m(), h(x, E)) : (h(0, E, g), T = !1)) : (B = 0, T = !1, f(!1)))
    }
    ...
    function c(e) {
      if (e.touches = e.touches || [{
            screenX: e.screenX,
            screenY: e.screenY
          }], (V || "mousemove" != e.type) && _ && !(e.touches.length > 1)) {
        if (null === V && (V = e.touches[0].screenY), ionic.Platform.isAndroid() && 4.4 === ionic.Platform.version() && 0 === y.scrollTop && (C = !0, e.preventDefault()), P = e.touches[0].screenY - V, 0 >= P - B || 0 !== y.scrollTop)return T && (T = !1, f(!1)), C && d(y, P - -1 * B), void(0 !== I && u(0));
        P > 0 && 0 === y.scrollTop && !T && (B = P), e.preventDefault(), T || (T = !0, f(!0)), C = !0, u((P - B) / 3), !A && I > x ? (A = !0, ionic.requestAnimationFrame(v)) : A && x > I && (A = !1, ionic.requestAnimationFrame(g))
      }
    }

    function s(e) {
      _ = 0 === e.target.scrollTop || C
    }

    function u(e) {
      S.style[ionic.CSS.TRANSFORM] = "translateY(" + e + "px)", I = e
    }
    ...
    function f(e) {
      e ? ionic.requestAnimationFrame(function () {
        S.classList.add("overscroll"), $()
      }) : ionic.requestAnimationFrame(function () {
        S.classList.remove("overscroll"), w(), g()
      })
    }
    ...
    function h(e, t, n) {
      ...
      function o() {
        ...
        u(Math.floor(l * (e - a) + a)), 1 > s ? ionic.requestAnimationFrame(o) : (5 > e && e > -5 && (T = !1, f(!1)), n && n())
      }
    ...
    function p() {
      ionic.off(D, c, S), ionic.off(L, a, S), ionic.off("mousedown", r, S), ionic.off("mousemove", c, S), ionic.off("mouseup", a, S), ionic.off("scroll", s, y), y = null, S = null
    }
    ...
    function g() {
      o(function () {
        n.removeClass("active refreshing refreshing-tail"), A && (A = !1)
      }, 150)
    }
    ...
    var y, S, k = this, C = !1, T = !1, B = 0, I = 0, x = 60, A = !1, E = 500, V = null, P = null, _ = !0;
    l(t.pullingIcon) || t.$set("pullingIcon", "ion-android-arrow-down"), e.showSpinner = !l(t.refreshingIcon) && "none" != t.spinner, e.showIcon = l(t.refreshingIcon), i(e, t, {
      ...
      o(function () {
        ionic.requestAnimationFrame(b), h(0, E, g), o(function () {
          T && (T = !1, f(!1))
        }, E)
      }, E)
    });
    var D, L;
    window.navigator.pointerEnabled ? (D = "pointermove", L = "pointerup") : window.navigator.msPointerEnabled ? (D = "MSPointerMove", L = "MSPointerUp") : (D = "touchmove", L = "touchend"), k.init = function () {
      if (y = n.parent().parent()[0], S = n.parent()[0], !(y && y.classList.contains("ionic-scroll") && S && S.classList.contains("scroll")))throw new Error("Refresher must be immediate child of ion-content or ion-scroll");
      ionic.on(D, c, S), ionic.on(L, a, S), ionic.on("mousedown", r, S), ionic.on("mousemove", c, S), ionic.on("mouseup", a, S), ionic.on("scroll", s, y), e.$on("$destroy", p)
    }, k.getRefresherDomMethods = function () {
      return {activate: v, deactivate: g, start: m, show: $, hide: w, tail: b}
    }, k.__handleTouchmove = c, k.__getScrollChild = function () {
      return S
    }, k.__getScrollParent = function () {
      return y
    }
    ...
    }, s.freezeScroll = u.freeze, s.freezeAllScrolls = function (e) {
    ...
    w.$scope = e, w.initialize = function (e) {
      ...
      (w.left && w.left.isEnabled || w.right && w.right.isEnabled) && (w.close(), $ = e, w.left && w.left.isEnabled && w.right && w.right.isEnabled ? w.content.setMarginLeftAndRight($ ? w.left.width : 0, $ ? w.right.width : 0) : w.left && w.left.isEnabled ? w.content.setMarginLeft($ ? w.left.width : 0) : w.right && w.right.isEnabled && w.content.setMarginRight($ ? w.right.width : 0), w.$scope.$emit("$ionicExposeAside", $))
    }, w.activeAsideResizing = function (e) {
      o.enableClass(e, "aside-resizing")
    }, w._endDrag = function (e) {
      l(!1), $ || (p && w.snapToRest(e), v = null, g = null, m = null)
    }, w._handleDrag = function (t) {
      !$ && e.dragContent && (v ? g = t.gesture.touches[0].pageX : (v = t.gesture.touches[0].pageX, g = v), !p && Math.abs(g - v) > w.dragThresholdX && (v = g, p = !0, w.content.disableAnimation(), m = w.getOpenAmount()), p && (w.openAmount(m + (g - v)), l(!0)))
      ...
      return arguments.length && (u(e) && e > 0 ? (w.edgeThreshold = e, w.edgeThresholdEnabled = !0) : w.edgeThresholdEnabled = !!e), w.edgeThresholdEnabled
    ...
    var y = h, S = angular.bind(w, w.close);
    e.$watch(function () {
      return 0 !== w.getOpenAmount()
    }, function (e) {
  ...
  }]), a.directive("ionLabel", ["$timeout", function (e) {
    return {
      restrict: "E", require: "?^ionInput", compile: function () {
        return function (t, n, i, o) {
          var r = n[0];
          n.addClass("input-label"), n.attr("aria-label", n.text());
          var a = r.id || "_label-" + ++k;
          r.id || n.attr("id", a), o && (o.setInputAriaLabeledBy(a), n.on("click", function () {
            e(function () {
              o.focus()
            })
          }))
  ...
  }), a.directive("ionSlides", ["$animate", "$timeout", function (e, t) {
    return {
      restrict: "E",
      transclude: !0,
      ...
      controller: ["$scope", "$element", function (e, n) {
        ...
        this.update = function () {
          t(function () {
            i.__slider.update(), i._options.loop && i.__slider.createLoop(), i.__slider.slides.length > 10 && (e.showPager = !1)
          })
        ...
        var o = e.options || {}, r = angular.extend({
          pagination: ".swiper-pagination",
          paginationClickable: !0,
          lazyLoading: !0,
          preloadImages: !1
        }, o);
        this._options = r, t(function () {
          var t = new ionic.views.Swiper(n.children()[0], r, e);
          i.__slider = t, e.slider = i.__slider, e.$on("$destroy", function () {
            t.destroy()
          })
        })
      }],
      link: function (t, n) {
        t.showPager = !0, e.enabled(!1, n)
      }
    }
